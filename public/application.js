...
var config = {
  apiOrigins: {
    production: 'https://jwywdip2.herokuapp.com',
...
var languageEvents = __webpack_require__(16);
...
var onGetLanguages = function onGetLanguages(event) {
  event.preventDefault();
  api.index().then(ui.getLanguagesSuccess).catch(ui.fail);
};

var onAddLanguage = function onAddLanguage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.create(data).then(ui.addSuccess).catch(ui.fail);
};

var onUpdateLanguage = function onUpdateLanguage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var id = data.userlanguage.id;
  api.update(id, data).then(ui.updateSuccess).catch(ui.fail);
};

var onDeleteLanguage = function onDeleteLanguage(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.destroy(data.userlanguage.id).then(ui.deleteSuccess).catch(ui.fail);
};
...
var showUserLangsTemplate = __webpack_require__(19);

var getLanguagesSuccess = function getLanguagesSuccess(data) {
  $('#content').text(null);
  $('.clearform').trigger('reset');
  var showUserLangsHtml = showUserLangsTemplate({ userlanguages: data.userlanguages });
...
var addSuccess = function addSuccess(data) {
  $('#content').text(null);
  $('.clearform').trigger('reset');
  var showUserLangsHtml = showUserLangsTemplate({ userlanguages: data });
  $('#content').append(showUserLangsHtml);
};
...
module.exports = {
  ...
  getLanguagesSuccess: getLanguagesSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<tr data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.language : stack1)) != null ? stack1.name : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.level : stack1), depth0))
    + "</td>\n  <td>"
    + alias2(alias1(((stack1 = ((stack1 = blockParams[0][0]) != null ? stack1.user : stack1)) != null ? stack1.name : stack1), depth0))
    + "\n</tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return "<table>\n  <tr>\n    <th>Record ID\n    </th>\n    <th>Language\n    </th>\n    <th>Level\n    </th>\n    <th>Username\n    </th>\n  </tr>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.userlanguages : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</table>\n";
